...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex items-center justify-center overflow-hidden rounded-full h-11 w-11 bg-brand-500 text-white font-medium text-lg">
          {user?.avatar ? (
            <img src={`/storage/${user.avatar}`} alt="User Profile" className="h-full w-full object-cover" />
          ) : (
